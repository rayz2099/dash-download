...
# 编译 macOS arm64 (.app). 编完必须冒烟: 1.2.1-1.2.3 配置能过 codesign, 但启动即 panic.
macos-arm:
    ...
    bash "{{root}}/.github/scripts/smoke_macos_app.sh" "{{root}}/target/{{target_macos}}/release/bundle/macos/Dash Download.app"
